...
def train(train_loader,model,criterion,optimizer,epoch,valid_loss,best_results,start):
  ...
  #  log.write("\n")
    log.add_scalar('train_loss', losses.avg, epoch)
    log.add_scalar('train_f1', f1.avg, epoch)
    #log.write(message)
    #log.write("\n")
...
def evaluate(val_loader,model,criterion,epoch,train_loss,best_results,start):
    ...
    with torch.no_grad():
        ...
        log.add_scalar('val_loss', losses.avg, epoch)
        log.add_scalar('val_f1', f1.avg, epoch)
        #log.write(message)
        #log.write("\n")
...
def test(test_loader,model,folds):
    ...
    sample_submission_df.to_csv('prev.csv', index=None)
